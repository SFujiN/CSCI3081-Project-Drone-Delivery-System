...
What just happened? You made lab01_git_basics your working directory with cd. You executed the makefile (named makefile) with make, which created object files with the extension .o, and the executable lab01.out. These files are displayed with ls.
...
What just happened? You ran the executable with ./lab01.out, which generated 2 files private.pvt and shared.md.
